...
<body>
    <div class="container" style="font-family: 'Kanit', sans-serif;">
        <div class='row'>
            ...
            <div class='col-8'>
                <div class='row mt-5'>
                    <div class="card pt-0 pb-1 mb-7" style="width: 50vw; height: 35vw; padding: 12px;">
                        <div class="row">
                            <div class="card-img-left m-0 p-0 col-4">
                                <img id='imge' style="width:270px;height: 34.9vw;" src="https://images.pexels.com/photos/6249428/pexels-photo-6249428.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="sans" />
                            </div>
                            <div class="col-8">
                                ...
                                <div class="card-body" style='vertical-align: middle;'>
                                    ...
                                    <form action="logIn_back.php" method="POST" onsubmit="" name="logIn">
                                        ...
                                        <br><br>
                                        <button type="submit" class="btn btn-success justify-content-md-end" name="submit">Log In!</button>
                                    </form>
                                    <h5 class="form-label m-2 mt-4">Create your account. <a href="reg_front.php">Sign Up!</a></h5>
                                </div>
                            </div>
                        </div>
                    </div>
