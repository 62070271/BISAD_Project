        ...
        <nav class="navbar navbar-expand-lg navbar-dark sticky-top" style="background-color: #395902;">
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link rounded text-dark" href="logIn_front.php"
                                style="background-color: #FBB03B;">Log In</a>
                        </li>
                        <li class="nav-item">
    ...
    <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner img-fluid">
            ...
            <div class="carousel-item img-fluid" data-bs-interval="6000">
                <img src="https://images.pexels.com/photos/247376/pexels-photo-247376.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
    ...
    <div class="container" style="font-family: sans-serif;">
                ...
                <div class="col-cnt">
                    <div class='card justify-content-md-end' style="width: 50rem; height: 12rem; margin : auto;">
                        <div class="card-body card-body-date">
                            ...
                            <input class="datepicker form-control" name="date" id="date" aria-owns="date_1_root"
                                aria-hidden='false' placeholder="pick date">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2 pl-2 d-flex justify-content-center">
                                    <button class="btn btn-primary flex-row-reverse mt-3" type="submit"
                                        name="pick_date">Choose</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row ">
            <div class="col pl-5">
                <form action="index_back.php" method="POST" name="book" onsubmit="return validateForm()">
                    <div class='card ml-5 ' id='num_book'
                        style="width: 50rem; height: 41rem; margin : auto; margin-top:4vw; margin-bottom: 3vw;">
                        <div class="card-body ">
                            ...
                            <div class="row bg-light " style="padding-left: 30px;">
                                <div class="box-input-type-card" style="height: 120px;">
                                    ...
                                    <div class="col-price" style="width: 10%;">
                                        ...
                                        <input class="type-card-1" type="number" step="any" min="0" value="0" max="35"
                                            name="type-card-1" id="type-card-1">
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="padding-left: 30px;">
                                <div class="box-input-type-card" style="height: 120px;">
                                    ...
                                    <div class="col-price" style="width: 10%;">
                                        <!-- <label for="type-card-1">number:</label> -->
                                        <input class="type-card-2" type="number" step="any" min="0" value="0" max="35"
                                            name="type-card-2" id="type-card-2">
                                    </div>
                                </div>
                            </div>
                            <div class="row bg-light" style="padding-left: 30px;">
                                <div class="box-input-type-card" style="height: 120px;">
                                    ...
                                    <div class="col-price" style="width: 10%;">
                                        <!-- <label for="type-card-1">number:</label> -->
                                        <input class="type-card-3" type="number" step="any" min="0" value="0" max="35"
                                            name="type-card-3" id="type-card-3">
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="padding-left: 30px;">
                                <div class="box-input-type-card" style="height: 120px;">
                                    ...
                                    <div class="col-price" style="width: 10%;">
                                        <!-- <label for="type-card-1">number:</label> -->
                                        <input class="type-card-4" type="number" step="any" min="0" value="0" max="35"
                                            name="type-card-4" id="type-card-4">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row p-0 m-0" style="height: 50%;">
                                        <div class='col p-2 m-0'>
                                            <h3 class=" m-2 rammeto ptyellow lh-base">Orange zone</h1>
                                                ...
                                                <button class=" btn rammeto border-2 border-warning ptyellow"
                                                    style="margin-top: 20px;"> View details</button>
                                        </div>
                                    </div>
                                    <div class="row p-0 m-0" style="height: 70%;">
                                        <div class='col p-0 m-0'>
                                            <img src="https://images.pexels.com/photos/2263936/pexels-photo-2263936.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260"
                                                style=" object-fit: none; display: inline-block; overflow: hidden; position: relative; width: 100%; height: 20rem;"
                                                class="card-img-bottom img-fluid" alt="...">
                                        </div>
                                    </div>
                                </div>
                                <div class='col-6 p-0 m-0'>
                                    <img src="https://images.pexels.com/photos/922519/pexels-photo-922519.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=350"
                                        style=" object-fit: none; display: inline-block; overflow: hidden; position: relative; width: 98.5%; height: 20rem;"
                                        class="card-img img-fluid" alt="...">
                                    <img src="https://static.thainationalparks.com/img/species/2013/11/25/7976/indian-muntjac-w-900.jpg"
                                        style=" object-fit: none; display: inline-block; overflow: hidden; position: relative; width: 98.5%; height: 20rem;"
                                        class="card-img-right img-fluid" alt="...">
                                </div>
                            </div>
        ...
        <div id='content-3' class="row mt-5 mb-1">
            ...
            <div class="col-6" style="height: 40rem;">
                <img class="rounded-circle circle_img"
                    src="https://static.thairath.co.th/media/PZnhTOtr5D3rd9ocK40waJor2MBKJwCcgOtJ6SlFesqczhb.webp"
                    alt="Generic placeholder image" width="350" height="350">
            ...
            <div class="col-6" style="height: 30rem;">
                <img class="rounded-circle circle_img"
                    src="https://static.thairath.co.th/media/PZnhTOtr5D3rd9ocK40waJor2MBKJwCcgkkZ6op4apFhInW.webp"
                    alt="Generic placeholder image" width="350" height="350">
        ...
        <div class="row " style="margin-bottom: 40px;">
            <div class='col'>
                <div class="card bg-dark" style="height: 25rem; ">
                    <img class="card-img"
                        src="https://images.pexels.com/photos/1436495/pexels-photo-1436495.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=650"
                        style="image-rendering:auto; object-fit: none; display: inline-block; overflow: hidden; position: relative; width: 100%; height: 25rem;"
        ...
        <div class="container mt-5 d-flex justify-content-center align-items-center">
            <div class="row" style="--bs-gutter-x: 0rem;">
                <div class="col-sm-6 ">
                    ...
                    <div class="row" style="--bs-gutter-x: 0rem;">
                        <div class="col-sm-6">
                            <img class="img-fluid" style="width: 100%; height: 60vh;"
                                src="https://images.pexels.com/photos/4577132/pexels-photo-4577132.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940">
                        </div>
                        <div class="col-sm-6 ">
                            <div class="row ">
                                <div class="col-sm-12 ">
                                    <img class="img-fluid" style="width: 100%; height: 30vh;"
                                        src="https://images.pexels.com/photos/3712289/pexels-photo-3712289.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940">
                                </div>
                            </div>
                            <div class="row ">
                                <div class="col-sm-12 ">
                                    <img class="img-fluid" style="width: 100%; height: 30vh;"
                                        src="https://images.pexels.com/photos/704434/pexels-photo-704434.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-6 ">
                    <div class="row " style="--bs-gutter-x: 0rem;">
                        <div class="col-sm-12 ">
                            <img class="img-fluid" style="width: 100%; height: 60vh;"
                                src="https://images.pexels.com/photos/4751260/pexels-photo-4751260.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940">
                        </div>
                    </div>
                    <div class="row" style="--bs-gutter-x: 0rem;">
                        <div class="col-sm-6 ">
                            <img class="img-fluid" style="width: 100%; height: 30vh;"
                                src="https://images.pexels.com/photos/735174/pexels-photo-735174.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940">
                        </div>
                        <div class="col-sm-6 ">
                            <img class="img-fluid" style="width: 100%; height: 30vh;"
                                src="https://cdn.pixabay.com/photo/2018/04/08/16/46/caiman-3301709_960_720.jpg">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container p-4">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
                ...
                <div class="row pt-3">
                    <div class="col-sm-3">
                        <a class="text-light" href="#!"><svg width="30" height="30" aria-hidden="true" focusable="false"
                                data-prefix="fab" data-icon="line" class="svg-inline--fa fa-line fa-w-14" role="img"
                    ...
                    <div class="col-sm-3">
                        <a class="text-light" href="#!"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
