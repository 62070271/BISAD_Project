    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            ...
            <div class="nav-item dropdown">
                <a class="nav-link dropdown-toggle text-light" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false"><?php echo "<img src='user_images/$user_image' alt='' width='30' height='30' class='d-inline-block align-text-top border border-white rounded-circle'>"; ?>&nbsp;<?php echo "$user_name"; ?></a>
    ...
    <div class="container">
        <div class="row" style="margin-top: 5vw">
            <div class="col" style="text-align: center;">
                <h2 style="text-align: center;" class="homepage_name text-warning">เลือกวันที่ต้องการจองบัตร</h2>
                <?php
                // if (isset($_SESSION['email'])) {
